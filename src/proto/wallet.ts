...
export const WalletServiceService = {
  createAddress: {
    path: "/WalletService/CreateAddress",
    requestStream: false,
  ...
  transaction: {
    path: "/WalletService/Transaction",
    requestStream: false,
    responseStream: false,
...
export const WalletServiceClient = makeGenericClientConstructor(WalletServiceService, "WalletService") as unknown as {
